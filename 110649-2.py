...
# Teine osa:
# Teadupärast on kosmosejaamas ruum piiratud. Ent ometigi tehakse ka rahvusvahelisse kosmosejaama aeg-ajalt turismireise. 
# Ütleme, et inimesed, keda lubatakse rahvusvahelisse kosmosejaama peavad olema kasvult maksimaalselt 190cm (kaasa arvatud) pikad. 
# Et eristada turiste töötajatest on töötajatel kaelakaart ja turistidel pilet.
# Koostada programm, mis küsib reisija pikkust sentimeetrites. 
# Seejärel küsib kas reisijal on pilet (jah, ei) 
# seejärel küsib kas reisijal on kaelakaart (jah, ei).
# Saanud reisijalt vastuse, et ta on alla 190 cm ja omab kas kaelakaarti või piletit, ilmub ekraanile kiri, 
# et reisija pääseb kosmoselennule.
